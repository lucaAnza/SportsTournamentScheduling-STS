...
\todo{Maybe ask chat to look for some reference we have only one}
...
tools required to run the experiments. He also carried out a comprehensive
revision of the entire report.

Martino Michelotti developed the complete CP model and designed the base MIP
formulation. He also contributed to the final revision of the report.
